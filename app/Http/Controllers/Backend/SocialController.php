...
class SocialController extends TrinataController
{
    ...
    {
        $model = $this->model->whereType('news')->first();

        $model = $this->model->select('id' , 'title','brief', 'description', 'image')->whereType('news');
    ...
    public function getIndex()
    {
        ...
        return view('backend.pagestatic.social.index',compact('model'));
    }
    ...
    public function postCreate(Request $request)
    {
        ...
        $data = $this->model->whereType('news')->first();
